...
Future additions can use the same six folders: Analog, Collaborations, Creative Process, Installations, Performances and Portraits. The gallery manifest is `assets/gallery/manifest.json`; `assets/gallery/gallery-data.js` is the browser-ready version of the same data.
...
- The approved downloadable press image is `downloads/samatar-elmi-press-photo.jpg`; photographer credit is TBC.
